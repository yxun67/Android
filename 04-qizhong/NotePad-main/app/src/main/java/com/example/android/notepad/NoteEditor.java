...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditorLayout = (LinearLayout) findViewById(R.id.editor_layout);
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            if (colColorIndex != -1 && !mCursor.isNull(colColorIndex)) {
                ...
                // Default to white if color column doesn't exist or is null
                mEditorLayout.setBackgroundColor(Color.WHITE);
                mCurrentColor = Color.WHITE;
            }
